...
class TestIntegrationBase:
    ...
    def test_setup_copies_templates(self, tmp_path, monkeypatch):
        ...
        assert (project / ".stub" / "commands" / "specpack.plan.md").exists()
        assert (project / ".stub" / "commands" / "specpack.specify.md").exists()
...
class TestBasePrimitives:
    ...
    def test_command_filename_default(self):
        i = StubIntegration()
        assert i.command_filename("plan") == "specpack.plan.md"
    ...
    def test_copy_command_to_directory(self, tmp_path):
        ...
        result = IntegrationBase.copy_command_to_directory(src, dest_dir, "specpack.plan.md")
        assert result == dest_dir / "specpack.plan.md"
